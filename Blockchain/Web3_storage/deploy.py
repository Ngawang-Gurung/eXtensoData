...
# Connecting to ganache: Ganache is a private Ethereum blockchain environment that allows to you emulate the Ethereum blockchain 
# so that you can interact with smart contracts in your own private blockchain
 
w3 = Web3(Web3.HTTPProvider("HTTP://127.0.0.1:7545")) # ganache-ui
chain_id = 1337  # print(w3.eth.chain_id)
my_address = "0xafd6B24FA91c0D28BAf321a0a85Fc5c93190037a" # ganache-ui

# w3 = Web3(Web3.HTTPProvider("HTTP://127.0.0.1:8545")) # ganache-cli
# my_address = "0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1" # ganache-cli
private_key = os.getenv("PRIVATE_KEY")

# Create contract in python

# Bytecode is the information that our Solidity code gets “translated” into.
# ABIs are application binary interfaces. They define the methods and variables that are available in a smart contract
#  and which we can use to interact with that smart contract. 
